...
<div class="top_infobar mb_release_note_color" id="top_jump">
	...
	<div class="content_wrapper_admin" id="ajax_area">
			...
			<?php 
				//var_dump(getVersionInfo(0,"byAllReleases")); 
				foreach (getVersionInfo(0,"byAllReleases") as $key => $value) {
					echo '<div class="admin_margin_wrapper" id="'.str_replace(".", "-", $value['version']) .'">
					<span class="show_info  ', ($value['version']==$release['stable']['version'])?'info_green':'dark_grey','">
					'.$value['appname'].'
					&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;Version '.$value['version'].'&nbsp;&nbsp;&nbsp;',
					'&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;Released on '.$value['release_date'].'&nbsp;&nbsp;&nbsp;',
					'&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;For '.$value['supported_os'].'&nbsp;&nbsp;&nbsp;',
					($value['version']==$release['stable']['version'])?'<p class="active">Current Release</p>&nbsp;&nbsp;&nbsp;':'',
					($value['major']==1)?'<p class="major">major Release</p>':'',
					'</span>';
					echo '<div class="info_table_wrap markdownView" >
					',($value['release_note_html']!=null)?$value['release_note_html']:'<div class="no_release_note" data-no-release-text="No Release Notes/Change Logs are provided for this version.&#xa;This is most likely a minor version and does not contain major changes"></div>','
					</div></div>';
				}
