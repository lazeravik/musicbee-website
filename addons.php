...
<head>
    ...
    <meta name="keywords"
    content="<?php echo $data['tags']; ?>, musicbee, music, player, unltimate, best, customizable, skin, free, plugin, download">
	...
	<div id="indexBackground">
		<div id="wrapper">
					...
					<div id="bg_image" class="general_info">
						...
						<div class="secondery_nav addon_secondery_nav" id="secondery_nav">
							<div class="secondery_nav_wrap">
								<ul class="left">
									<li><a href="<?php echo $link['addon']['home'] . "all/"; ?>" id=""><?php echo $lang['18']; ?></a></li>
									<?Php
									...
									<div class="general_info_text_wrap">
										<div class="general_info_title">
											...
											<div class="general_info_addon_meta">
												<p><?php echo $lang['252']; ?> <?php echo $author['membername']; ?></p>
            ...
            <div class="addon_similar more_from_author">
            	<div class="addon_similar_wrap">
            		<h2><?php echo $lang['260'] . $author['membername']; ?></h2>
            	</div>
            </div>
            <div class="addon_similar more_from_author">
            	<div class="addon_similar_wrap from_author">
            		...
            		<ul class="addon_list_box">
            			<?php foreach ($from_author as $key => $addon_data):
            			...
            			<li id ="<?php echo $addon_data['ID_ADDON']; ?>">
            				<div class="addon_list_box_wrapper">
            					<a href="<?php echo $addon_link; ?>">
            						...
            						<div class="love"><i class="fa fa-heart"></i><p class="love_count">0</p></div>
            					</a>
            					<div class="addon_list_box_info">
            						<a href="<?php echo $addon_link; ?>">
            							<p class="title"><?php echo $addon_data['addon_title']; ?></p>
            						</a>
            						<p class="author"><?php echo $lang['252']; ?> <?php echo $addon_author['membername']; ?></p>
            					</div>
            				</div>
            			</li>
            		<?php endforeach; ?>
            	...
            	<div class="more_addon">
            		<a class="blue_btn_big" href="javascript:void(0)">
            			...
            			<p><?php echo $lang['262']; ?> <?php echo $author['membername']; ?></p>
            		</a>
            	</div>
...
function notificationCallback(data) {
	...
	if (obj.loved != null) {
		rateStatusUpdate(obj.loved);
	}
}

function rateStatusUpdate (rate_stat) {
