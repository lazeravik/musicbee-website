var MBEditor = MBEditor || {};
MBEditor.wmdBase = function(){

// A few handy aliases for readability.
var wmd  = top.MBEditor;
...
util.prompt = function(text, defaultInputText, makeLinkMarkdown){
	...
	var createDialog = function(){
		...
		okButton.className ="btn btn_blue";
		...
		cancelButton.className ="btn btn_red";
...
wmd.editor = function(previewRefreshCallback){
	...
	var makeSpritedButtonRow = function(){
		...
		boldButton.className = "editor_btn";
		boldButton.id = "wmd-bold-button";
		boldButton.innerHTML ="<i class=\"fa fa-bold\"></i>";
		...
		italicButton.className = "editor_btn";
		italicButton.id = "wmd-italic-button";
		italicButton.title = "Emphasis <em> Ctrl+I";
		italicButton.innerHTML ="<i class=\"fa fa-italic\"></i>";
		...
		linkButton.className = "editor_btn";
		...
		quoteButton.className = "editor_btn";
		quoteButton.id = "wmd-quote-button";
		quoteButton.innerHTML ="<i class=\"fa fa-quote-left\"></i>";
		...
		codeButton.className = "editor_btn";
		codeButton.id = "wmd-code-button";
		codeButton.title = "Code Sample <pre><code> Ctrl+K";
		codeButton.innerHTML ="<i class=\"fa fa-code\"></i>";
		codeButton.textOp = command.codeMD;
		setupButton(codeButton, true);
		buttonRow.appendChild(codeButton);

		var imageButton = document.createElement("li");
		imageButton.className = "editor_btn";
		imageButton.id = "wmd-image-button";
		imageButton.title = "Image <img> Ctrl+G";
		imageButton.innerHTML ="<i class=\"fa fa-image\"></i>";
		...
		olistButton.className = "editor_btn";
		olistButton.id = "wmd-olist-button";
		olistButton.innerHTML ="<i class=\"fa fa-list-ol\"></i>";
		...
		ulistButton.className = "editor_btn";
		ulistButton.id = "wmd-ulist-button";
		ulistButton.innerHTML ="<i class=\"fa fa-list-ul\"></i>";
		...
		headingButton.className = "editor_btn";
		headingButton.id = "wmd-heading-button";
		headingButton.innerHTML ="<i class=\"fa fa-header\"></i>";
		...
		hrButton.className = "editor_btn";
		hrButton.id = "wmd-hr-button";
		hrButton.innerHTML ="<i class=\"fa fa-arrows-h\"></i>";
		...
		clearDiv.id = "clear";
		buttonRow.appendChild(clearDiv); 
...
/* MODIFIED Code markup */
command.codeMD = function(chunk, nStars, insertText){
		// In most cases, if you don't have any selected text and click the button
		// you'll get a selected, marked up region with the default text inserted.
		if (!chunk.selection) {
...
util.startEditor = function(){
	...
	// WHO THE FUCK EVEN THOUGH IT WAS A GOOD IDEA TO LOAD IT WHEN PAGE FULLY LOADS X(
	// Specially without jquery!! THIS WON'T WORK WITH AJAX!
	// removing that SHIT piece of work now works with ajax, and yes i am angry X(
...
command.doAutoindent = function(chunk, postProcessing, useDefaultText){
	...
	if(/(\n|^)(\t|[ ]{4,}).*\n$/.test(chunk.before)){
		if(command.codeMD){
			command.codeMD(chunk, postProcessing, useDefaultText);
