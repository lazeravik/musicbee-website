...
require('class.filereader.php');
require('class.streamreader.php');
require('class.stringreader.php');
require('class.textreader.php');
require('class.cachedfilereader.php');
