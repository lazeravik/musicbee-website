    					...
    					<div id="bg_image" class="general_info">
    						...
    						<div class="secondery_nav addon_secondery_nav secondery_nav_color" id="secondery_nav">
    							<div class="secondery_nav_wrap">
    								<ul class="left">
    									<li><a href="<?php echo $link['addon']['home'] . "all/"; ?>" id="all_active_page"><?php echo $lang['18']; ?></a></li>
    									<?Php
    								...
    								<div class="sub_content">
    									<div class="search_box">
    										<div class="search_box_wrap">
    											<form method="GET" action="<?php echo $link['addon']['home']; ?>">
    												<p><label for="order">Search: </label></p>
    												<div class="search_left">
    													<input type="text" class="srch big_search" id="big_search" name="q" placeholder="Search <?php echo $data['type']; ?>"/>
    												</div>
