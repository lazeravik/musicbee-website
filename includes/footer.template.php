...
<div class="footer_section">
	<div id="widget">
			...
			<h4><?php echo $lang['179']; ?></h4>
			<ul>
				<li>
					<a href="<?php echo $link['download']; ?>" class="btn btn_grey">
						<i class="fa fa-download"></i> <?php echo $lang['180']; ?> <?php echo $release['stable']['appname']; ?>
					</a>
				</li>
				<li><?php echo $lang['181']; ?> <?php echo $release['stable']['version']; ?></li>
				<li>
					<?php echo $lang['156']; ?> <?php echo $release['stable']['os']; ?>
				</li>
				<li><?php echo $lang['182']; ?> <?php echo $release['stable']['date']; ?></li>
				<br/>
				<li class="line"></li>
				<br/>
				<li><?php echo $lang['186']; ?></li>
				<li>
					<a href="<?php echo $link['rss']; ?>" class="btn btn_red" target="_blank">
						<i class="fa fa-rss"></i> <?php echo $lang['184']; ?>
					</a>
				</li>
		...
		<div id="widgetCommunity"  class="widgetCommon">
			...
			<ul class="footer-list-menu">
				<li><a href="<?php echo $link['devapi']; ?>"><?php echo $lang['185']; ?></a></li>
				<li><a href="<?php echo $link['bugreport']; ?>"><?php echo $lang['187']; ?></a></li>
				<li><a href="<?php echo $link['forum']; ?>"><?php echo $lang['191']; ?></a></li>
				<li><a href="<?php echo $link['press']; ?>"><?php echo $lang['231']; ?></a></li>
				<ul class="footer_donation">
				<li><?php echo $lang['189']; ?></li>
				<li>
					<a href="https://www.paypal.com/cgi-bin/webscr?cmd=_donations&business=9BPHYSSZDDWDY&lc=GB&item_name=MusicBee&currency_code=USD&bn=PP%2dDonationsBF%3abtn_donateCC_LG%2egif%3aNonHosted" target="_blank" class="btn btn_blue" >
						<i class="fa fa-paypal"></i> <?php echo $lang['190']; ?>
					</a>
				</li>
				</ul>
			</ul>
...
<div id="footer">
	<div id="widget">
		<div class="footer_credit">
			<p><?php echo $lang['192']; ?></p>
			<p id="copyright"><?php echo $lang['193']; ?></p>
