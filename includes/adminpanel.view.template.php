				...
				foreach ($allRecords as $record) {
					...
					<tr id=\"".$record['ID_ALLVERSIONS']."_tbl\" class=\"",$activeRecordClass,"\">
						...
						<td>",($record['major']==1)? "<p class='major'>major</p>" : "...";
							...
							<td>",($record['dashboard_availablity']==1)?"Yes":"No"; echo"</td>
			...
			<div class="info_table_wrap">
				...
				<div id="disable_enable_stable_download_disable">
					<?php if (getAvavilability(0) == 1) : ?>
						<a id="stable_download_disable" data-disable="true" class="btn btn_red" onclick="changeDownload(this.id);">Disable Downloads</a>
					<?php else: ?>
						<a id="stable_download_disable" data-disable="false" class="btn btn_green" onclick="changeDownload(this.id);">Enable Downloads</a>
					<?php endif; ?>
				</div>
			</div>
		</div>
			...
			<div class="info_table_wrap">
				...
				<div id="disable_enable_beta_download_disable">
					<?php if (getAvavilability(1) == 1) : ?>
						<a id="beta_download_disable" data-disable="true" class="btn btn_red" onclick="changeDownload(this.id);">Disable Downloads</a>
					<?php else: ?>
						<a id="beta_download_disable" data-disable="false" class="btn btn_green" onclick="changeDownload(this.id);">Enable Downloads</a>
					<?php endif; ?>
				</div>
			</div>
		</div>
