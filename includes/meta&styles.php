...
<link rel="stylesheet" type="text/css" href="<?php echo $link['url']; ?>styles/dist/mb_main.css?<?php echo $mb['website']['ver']; ?>">
<link rel="stylesheet" href="<?php echo $link['url']; ?>styles/font-awesome.min.css?4.5.0">
