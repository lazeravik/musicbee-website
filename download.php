			...
			<div id="main">
				<div id="main_panel">
					<div class="content mb_download_installer_bg">
						<div class="secondery_bg_download">
							...
							<?php if ($release['stable']['available'] == 1) : ?>
									<div class="installer_layer_wrapper installer_non_portable">
										<h3 class="installer_header_h3">Installer Edition</h3>
										<p>
											This edition will install MusicBee on your Windows system drive
										</p>
										<a href="<?php echo $release['stable']['link1']; ?>" target="_blank" class="download_link_big">
											<i class="fa fa-download"></i> Get MusicBee Installer
										</a><br/>
										<a href="<?php echo $release['stable']['link2']; ?>" target="_blank" class="download_link_big">
											Mirror 1
										</a> 
										<a href="<?php echo $release['stable']['link3']; ?>" target="_blank" class="download_link_big">
											Mirror 2
										</a>
									</div>
									
									<div class="installer_layer_wrapper mb_portable_download_bg">
										<h3 class="installer_header_h3">Portable Edition</h3>
										<p>This edition can be installed in other locations, such as another partition or USB drive</p>
										<a href="<?php echo $release['stable']['link4']; ?>" target="_blank" class="download_link_big">
											<i class="fa fa-download"></i> Get MusicBee Portable
										</a>
										<p class="mb_ver_choose_detail" data-popup-help="Most users will want to use the Installer Edition.&#xa;&#xa;Reasons to choose the Portable Edition:&#xa;- Limited user rights to install MusicBee on system drive&#xa;- No modification to your system files or folders&#xa;- Running MusicBee from a USB drive for portability">Which edition should I use?</p>
									</div>
								<?php else: ?>
									<div class="installer_layer_wrapper installer_non_portable">
										<h3 class="installer_header_h3">Installer Downloads are disabled!</h3>
									</div>
									<div class="installer_layer_wrapper mb_portable_download_bg">
							...
							<p>It is intended for anyone interested in trying the latest features or bug fixes.
							   You should regularly check the forum for updates.</p>
								...
								<?php if($release['beta']['available'] == 1) : 
										 if($release['beta']['message'] != null)
											echo '<p class="show_info">'.$release['beta']['message'].'</p>';?>
								<a href="<?php echo $release['beta']['link1']; ?>" target="_blank" class="download_link_big">
									<i class="fa fa-warning"></i> Get MusicBee Beta
								</a>
							<?php else: ?>
								<p class="show_info info_yellow">Download is Disabled for MusicBee Beta, checkout our forum for more info</p>
							<?php endif; ?>
